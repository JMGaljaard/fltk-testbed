...
def get_learning_param_config(args, alt_path: str = None) -> Optional[learn_config.DistLearnerConfig]:
    ...
    if args:
        ...
        config_path = alt_path
    try:
        learning_params = learn_config.DistLearnerConfig.from_yaml(Path(config_path))
